...
/**
 * Created by nfl 2018/11/12 11:09
 * 频域水印工具
 */
public class FrequencyDomainWatermarkingUtil {

    private static List<Mat> planes;
    private static Mat complexImage;

    private FrequencyDomainWatermarkingUtil() {
    }

    private static final FrequencyDomainWatermarkingUtil frequencyDomainWatermarkingUtil = new FrequencyDomainWatermarkingUtil();

    public static FrequencyDomainWatermarkingUtil getInstance() {
        planes = new ArrayList<>();
        complexImage = new Mat();
        return frequencyDomainWatermarkingUtil;
    }
