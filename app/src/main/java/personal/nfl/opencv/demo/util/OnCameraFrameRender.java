...
public class OnCameraFrameRender {
    ...
    public static abstract class FrameRender {
        protected CameraCalibrator mCalibrator;

        public abstract Mat render(CvCameraViewFrame inputFrame);
    }

    public static class PreviewFrameRender extends FrameRender {
        @Override
        public Mat render(CvCameraViewFrame inputFrame) {
    ...
    public static class CalibrationFrameRender extends FrameRender {
    ...
    public static class UndistortionFrameRender extends FrameRender {
    ...
    public static class ComparisonFrameRender extends FrameRender {
        private int mWidth;
        private int mHeight;
